...
def parse():
    ...
    # standard input
    parser.add_argument(
        "-r", "--runname", type=str, help=("folder to store the results"))
    parser.add_argument("-d", "--dcdfile", type=str, help=(
        "dcd/pdb file containing the structure frames for scattering calculation"))
    parser.add_argument("-dp", "--dcdpath", type=str, default='minimization/', help=(
        "path to the dcd/pdb file containing the structures for scattering calculation"))
