...
error,mask1 = m.get_subset_mask(basis1) ; assert not len(error)>0,  error
...
error,mask2 = m.get_subset_mask(basis2) ; assert not len(error)>0,  error
...
error,mask3 = m.get_subset_mask(basis3) ; assert not len(error)>0,  error
...
error,mask4 = m.get_subset_mask(basis4) ; assert not len(error)>0,  error
...
error,mask5 = m.get_subset_mask(basis5) ; assert not len(error)>0,  error
...
error,mask6 = m.get_subset_mask(basis6) ; assert not len(error)>0,  error
print 'done with mask6'

basis7 = '(segname[i] == "DNA1" and (resid[i] > 498)) or (segname[i] == "DNA2" and (resid[i] < 30))'
error,mask7 = m.get_subset_mask(basis7) ; assert not len(error)>0,  error
...
error = m.set_descriptor_using_mask(mask1,segname,ns1) ; assert not len(error)>0,  error
error = m.set_descriptor_using_mask(mask2,segname,ns2) ; assert not len(error)>0,  error
error = m.set_descriptor_using_mask(mask3,segname,ns3) ; assert not len(error)>0,  error
error = m.set_descriptor_using_mask(mask4,segname,ns4) ; assert not len(error)>0,  error
error = m.set_descriptor_using_mask(mask5,segname,ns5) ; assert not len(error)>0,  error
error = m.set_descriptor_using_mask(mask6,segname,ns6) ; assert not len(error)>0,  error
error = m.set_descriptor_using_mask(mask7,segname,ns7) ; assert not len(error)>0,  error
