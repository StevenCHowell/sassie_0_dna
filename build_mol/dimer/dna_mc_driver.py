...
if __name__ == "__main__":
    ...
    svariables['theta_z_max']           = ('1', 'float_array') # provide 's_theta_z_max' to use a different theta max for twisting vs bending
    ...
    #s svariables['align_high_res']        = ('15', 'int')  # not yet implemented
    ...
    svariables['rigid_group2']          = ('A1, B1, C1, D1, E1, F1, G1, H1', 'string_array')
