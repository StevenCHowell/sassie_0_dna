...
# Created: 04/24/2014
# $Id: replaceSequence.py 112 2015-01-22 17:35:40Z schowell $
'''
...
chain1_out = 'dna2_bb_right-seq.pdb'
chain1_pdb = 'dna2_bb_wrong-seq.pdb'
chain1 = sasmol.SasMol(0)
chain1.read_pdb(chain1_pdb)

chain2_out = 'dna1_bb_right-seq.pdb'
chain2_pdb = 'dna1_bb_wrong-seq.pdb'
chain2 = sasmol.SasMol(0)
chain2.read_pdb(chain2_pdb)

sequenceFile = 'dimer.seq'
