...
def get_tetramer_angles(all_ncp_axes, all_ncp_origins):
    ...
    # solve this linear system: x * X_1 + y * Y_1 + z * Z_1 = O_2 - O_1
    # (reversible)
    results = []
    for i in xrange(len(ncp1_origins)):
        a = np.array(
            [ncp1_axes[i, 0, :], ncp1_axes[i, 1, :], ncp1_axes[i, 2, :]]).transpose()
...
if __name__ == '__main__':
    ...
    dna_ids = [['DNA1', 'DNA2']] * 4
    ncp_dna_resids = [
        bps[[26, 166]], bps[[193, 333]], bps[[360, 500]], bps[[527, 667]]]
    ncp_dyad_resids = [bps[96], bps[263], bps[430], bps[597]]
    ncp_ref_atom_resids = [37, 204, 371, 538]
    # the 1ZBB structure with corrected DNA sequence and completed proteins
    # (default)
    ...
    # stack distances:                       [57.807627493800133,
    # 58.212257694966162]
    ...
    # stack distances:                       [62.745230145841695,
    # 63.144230926884156]
    ...
    # stack distances:                       [32.972430152964371,
    # 33.373636182110772]
    ...
    # stack distances:                       [57.809280925176395,
    # 58.205898862508221]
    ...
    if False:
        ...
        ax.plot(n2_x_axis_vec[:, 0], n2_x_axis_vec[:, 1],
                n2_x_axis_vec[:, 2], 'm-', label='NCP2_X')
